...
def build_legend(title: str, seed: int | None = None) -> Legend:
    ...
    return Legend(
        title=title,
        backstory="The hill rises before you—low, flat-topped, its sides thick with weeds, thorns, and briars. "
        "Tales say the crypt lies beneath: traps, guardians, and treasures. You have found the place. The entrance "
        "is hidden; only a careful search will reveal it. What do you do?",
        locale_options=[
